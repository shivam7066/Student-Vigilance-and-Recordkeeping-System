  ...
  <ul class="nav nav-tabs-justified">
   ...
   <div class="panel panel-info">
      ...
      <div class="panel-body">
						...
						for(i=0;i<count;i++)
						status[i]=Integer.parseInt(request.getParameter("att"+i));
						...
						st.executeUpdate("insert into "+std+div+"_attendance(date,subject) values('"+date+"','"+subject+"');");
						...
						//out.print(id);
						st=con.createStatement();
						cnt=st.executeUpdate("update "+std+div+"_attendance set "+id+"="+status[i]+" where date='"+date+"' and subject='"+subject+"' ;");
						i++;
						}

						if(cnt>0)
							out.print("Attendance Submitted..");
						}
						catch(Exception e)
						{
						e.printStackTrace();
