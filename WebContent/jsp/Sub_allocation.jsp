...
<ol class="breadcrumb" >
  ...
  <li class="active">Sub Allocation</li>
</ol>
...
<div class="col-md-3 ">
  ...
  <ul class="nav nav-tabs-justified">
   ...
   <div class="panel panel-info">
      <div class="panel panel-heading">
         <h3 class="panel-title">Subject Allocation</h3>
      </div>
      <div class="panel-body">
                   <div id="reg">
                                    <center>
              ...
              /* function called to do Ajax Request */
                ...
                var url="Sub_allocation_display.jsp?semVal="+semVal+"&deptVal="+deptVal;
              ...
              Class :
                      <label>
                      <select name="sem_select" id="sem_select" class="textbox1">
              ...
              Division :
              <select name="dept_select" id="dept_select" class="textbox1" onchange="populateSubjectMenu();">
                        <option value="">-- Select --</option>
