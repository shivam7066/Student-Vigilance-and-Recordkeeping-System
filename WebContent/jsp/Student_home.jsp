...
<div class="col-md-3 ">
  ...
  <ul class="nav nav-tabs-justified">
   <li><a href="../jsp/Student_home.jsp" class="c">Student Home</a></li>
    <li><a href="../html/rr.html" class="d">View Marks</a></li>
    <li><a href="html/download.html" class="d">Downloads</a></li>
    <li><a href="Update_stud_data.jsp" class="e">Update Your Profile</a></li>
   ...
   <div class="panel panel-info">
      ...
      <div class="panel-body">
					...
					<br />
					<li>
					<a href="../html/rr.html">VIEW MARKS</a>
					</li><br />
					<li>
					<a href="Update_stud_data.jsp">UPDATE YOUR PROFILE</a>
					</li>
					</ul>
