...
<%@ page import="java.sql.*"%>
				...
				try{
					...
					String midnm=request.getParameter("midnm");
					String mothernm=request.getParameter("mothernm");
					String surnm=request.getParameter("surnm");
					...
					String DOBOFADM=request.getParameter("DOBOFADM");
				...
				st.executeUpdate("insert into stud_personal_db values('"+userid+"','"+fnm+"','"+midnm+"','"+mothernm+"','"+surnm+"','"+DOB+"',"+Std+",'"+semail+"','"+pemail+"','"+smob+"','"+pmob+"','"+address+"','"+div+"','"+DOBOFADM+"','"+Pwd+"','student','active');");


				st=con.createStatement();
				st.executeUpdate("alter table "+Std+div+"_attendance ADD "+userid+"  VARCHAR(10);");
				
				st=con.createStatement();
				st.executeUpdate("insert into ut1 values('"+userid+"',"+Std+",'"+div+"',0,0,0,0,0,0,0,0);");

				st=con.createStatement();
				st.executeUpdate("insert into ut2 values('"+userid+"',"+Std+",'"+div+"',0,0,0,0,0,0,0,0);");

				st=con.createStatement();
				st.executeUpdate("insert into end_sem1 values('"+userid+"',"+Std+",'"+div+"',0,0,0,0,0,0,0,0);");
				st=con.createStatement();
				st.executeUpdate("insert into end_sem2 values('"+userid+"',"+Std+",'"+div+"',0,0,0,0,0,0,0,0);");
				out.print("Student Registered Succesfully");
				}
				catch(Exception e)
				{
				out.print(e);
