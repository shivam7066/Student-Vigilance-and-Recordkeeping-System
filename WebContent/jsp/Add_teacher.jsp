...
<div class="col-md-3 ">
  ...
  <ul class="nav nav-tabs-justified">
   ...
   <div class="panel panel-info">
      <div class="panel panel-heading">
         <h3 class="panel-title">ADD TEACHER SECTION</h3>
      </div>
      <div class="panel-body">
				...
				String ID, NM, PS, EMAIL, CONTACT;
				int cnt=0;


				ID= request.getParameter("Teacher ID");
				NM= request.getParameter("Name");
				PS= request.getParameter("Default password");
				...
				pst=con.prepareStatement("insert into teacher_personal_db (TID, Password, userstatus, usertype, name, email, contact_no) values(?,?,?,?,?,?,?);");
				...
				if(cnt>0)
					...
					out.println(" SORRY!! Some error occurred because no record updated ");
