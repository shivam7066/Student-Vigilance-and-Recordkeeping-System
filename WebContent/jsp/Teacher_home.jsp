...
<ol class="breadcrumb" >
  ...
  <li class="active">Teacher Home</li>
</ol>
...
<div class="col-md-3 ">
  ...
  <li><a href="../jsp/Teacher_home.jsp" class="c">Teacher Home</a></li>
   ...
   <div class="panel panel-info">
      <div class="panel panel-heading">
         <h3 class="panel-title">Teacher Home</h3>
      </div>
      <div class="panel-body">
                              <div id="reg">
                            ...
                            <ul>
                          <li>  
                          <a href="../html/Attendance_Ajax.html">ATTENDANCE</a>
                          </li>
                          <br />
                          <li>
                          <a href="../html/Stud_reg.html">NEW STUDENT REGISTRATION</a>
                          </li>
                          <br />
                          <li>
                          <a href="../html/Result1.html">UPDATE RESULT</a>
                          </li>
                          <br />
                          <li>
                          <a href="../html/View_att.html">VIEW ATTENDANCE</a>
                          </li>
                          <br />
                          
                          <li>
                          <a href="Update_teacher_data.jsp">UPDATE YOUR PROFILE</a>
                          </li>
                          </ul>
